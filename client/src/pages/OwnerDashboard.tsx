...
type OperationsData = {
  ...
  directors: Array<{ id: number; name: string; username: string; companyId: number | null; companyName: string | null; eventIds: number[] }>;
