  ...
  return (
    <div className="captain-login-bg min-h-screen flex flex-col">
      ...
      <header className="captain-login-header px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 cursor-default select-none"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-400/15 text-xl">⭐</span><div className="flex flex-col leading-tight"><span className="font-black text-white text-base tracking-widest uppercase" style={{ fontFamily: "'Orbitron', sans-serif" }}>Team Captain Portal</span><span className="text-xs font-semibold tracking-widest uppercase text-amber-300">Secure Event Access</span></div></div>
        <div className="w-24" />
      </header>
